...
public class stockcontroller {
	...
	public Stockmodel savedetails(@RequestBody Stockmodel id) 
	
	{
		return sser.savedetails(id);
	}
	@Tag(name = "Deleting",description = "Deleting the given details")
	@DeleteMapping("/deleteid/{hi}")
	public String deletedetails(@PathVariable("id")int id)
	{
		sser.deletedetails(id);
		return "deleted";
	...
	{
		return sser.getdetails(id);
	}
	@Tag(name = "Updating",description = "Update the given details")
	@PutMapping("/updatestock")
	
	public Stockmodel updatedetails(@RequestBody Stockmodel id)
	{
		return sser.updateInfo(id);
	}
	//sorting 
	@Tag(name = "Get Details",description = "To get the required detail")
